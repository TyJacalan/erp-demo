...
Client.create_or_find_by!(name: 'Saha Global') do |client|
...
Client.create_or_find_by!(name: 'BOMA') do |client|
...
Client.create_or_find_by!(name: 'Lewa Wildlife Conservation') do |client|
